<?php
$this->pageTitle=Yii::app()->name . ' - ServiceNew';
?>
...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('app','Technical Service new'); ?></strong>
	</h1>
<!--
	<ol class="breadcrumb">
...
<section class="content">
	...
	<div class="btn-group" role="group">
		<?php 
			if (Yii::app()->user->validRWFunction('TL06'))
    ...
    $this->widget('ext.layout.ListPageWidget', array(
        'title'=>Yii::t('rank','ServiceNew List'),
        'model'=>$model,
        'viewhdr'=>'//serviceNew/_listhdr',
        'viewdtl'=>'//serviceNew/_listdtl',
        'gridsize'=>'24',
        'height'=>'600',
