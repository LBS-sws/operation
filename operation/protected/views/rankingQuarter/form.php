<?php
$this->pageTitle=Yii::app()->name . ' - RankingQuarter Form';
?>

<?php $form=$this->beginWidget('TbActiveForm', array(
'id'=>'RankingQuarter-form',
...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('rank','RankingQuarter Form'); ?></strong>
	</h1>
<!--
	<ol class="breadcrumb">
...
<section class="content">
	...
	<div class="btn-group" role="group">
		<?php echo TbHtml::button('<span class="fa fa-reply"></span> '.Yii::t('misc','Back'), array(
				'submit'=>Yii::app()->createUrl('rankingQuarter/index')));
		?>
	</div>
	</div></div>
	...
	<div class="box box-info">
		<div class="box-body">
            ...
            <div class="form-group">
                <?php
                echo TbHtml::label(Yii::t("rank","quarter"),'rank_month',array('class'=>"col-lg-2 control-label"));
                ?>
                <div class="col-lg-3">
                    <?php
                    echo TbHtml::textField("rank_month",RankingQuarterList::getQuarterList($model->rank_month,true),
                        array('readonly'=>(true))
                    );
                    ?>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-3">
                    ...
                    <?php
                    echo TbHtml::link(Yii::t("rank","month list detail"),'javascript:void(0);',array(
                        'class'=>'btn_detail',
                        'data-title'=>Yii::t("rank","month list detail"),
                        'data-value'=>"month_detail",
                        'data-id'=>$model->employee_id,
                        'data-year'=>$model->rank_year,
                        'data-month'=>$model->rank_month,
                    ));
