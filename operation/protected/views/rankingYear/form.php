<?php
$this->pageTitle=Yii::app()->name . ' - RankingYear Form';
?>
...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('rank','RankingYear Form'); ?></strong>
	</h1>
<!--
	<ol class="breadcrumb">
...
<section class="content">
	...
	<div class="btn-group" role="group">
		<?php echo TbHtml::button('<span class="fa fa-reply"></span> '.Yii::t('misc','Back'), array(
				'submit'=>Yii::app()->createUrl('rankingYear/index')));
		?>
	</div>
	</div></div>
	...
	<div class="box box-info">
		<div class="box-body">
            ...
            <div class="form-group">
                <?php
                echo TbHtml::label(Yii::t("rank","annual"),'rank_month',array('class'=>"col-lg-2 control-label"));
                ?>
                <div class="col-lg-3">
                    <?php
                    echo TbHtml::textField("rank_month","1-12".Yii::t("rank","month unit"),
                        array('readonly'=>(true))
                    );
                    ?>
                </div>
