...
?>
<?php
$this->pageTitle=Yii::app()->name . ' - salesOut List';
?>
...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('app','Sales outbound'); ?></strong>
	</h1>
<!--
	<ol class="breadcrumb">
...
<section class="content">
    <div class="box">
        <div class="box-body">
            <div class="btn-group" role="group">
                ...
                if (Yii::app()->user->validRWFunction('YC03')){
					echo TbHtml::button('<span class="fa fa-file-o"></span> '.Yii::t('procurement','Add requisition sales'), array(
    ...
    $this->widget('ext.layout.ListPageWidget', array(
        'title'=>Yii::t('app','Sales outbound'),
        'model'=>$model,
        'viewhdr'=>'//salesOut/_listhdr',
        'viewdtl'=>'//salesOut/_listdtl',
...
<?php $this->renderPartial('//site/citySelect',array("submitUrl"=>Yii::app()->createUrl('salesOut/new'))); ?>
<?php
$js = "
