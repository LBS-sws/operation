...
if (empty($model->id)&&$model->scenario == "edit"){
    $this->redirect(Yii::app()->createUrl('goodsdo/new'));
}
    ...
    <div class="box box-info">
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <?php echo $form->dropDownList($model, 'classify_id',ClassifyForm::getAllClassifyList("Domestic"),
...
$("#radio-change input").on("change",function(){
    ...
    if(num == 0 || num == 1){
        ...
        $("#row"+(1-num)).hide();
        if(num == 0){
            $("#GoodsDoForm_rules_id").val(0);
        }
        if($("#GoodsDoForm_small_num").val() < 1){
            $("#GoodsDoForm_small_num").val(1);
        }
        if($("#GoodsDoForm_big_num").val() < 1){
            $("#GoodsDoForm_big_num").val(1);
        }
        if($("#GoodsDoForm_multiple").val() < 1){
            $("#GoodsDoForm_multiple").val(1);
        }
    }
});
