<?php
$this->pageTitle=Yii::app()->name . ' - RankingHalf Form';
?>
...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('rank','RankingHalf Form'); ?></strong>
	</h1>
<!--
	<ol class="breadcrumb">
...
<section class="content">
	...
	<div class="btn-group" role="group">
		<?php echo TbHtml::button('<span class="fa fa-reply"></span> '.Yii::t('misc','Back'), array(
				'submit'=>Yii::app()->createUrl('rankingHalf/index')));
		?>
	</div>
	</div></div>
