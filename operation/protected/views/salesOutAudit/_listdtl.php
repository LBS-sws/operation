...
?>
<?php
$htmlTrHref = $this->getLink('YD12', 'salesOutAudit/edit', 'salesOutAudit/view', array('index'=>$this->record['id']));
...
-->
	<td><?php echo $this->drawEditButton('YD12', 'salesOutAudit/edit', 'salesOutAudit/view', array('index'=>$this->record['id'])); ?></td>
