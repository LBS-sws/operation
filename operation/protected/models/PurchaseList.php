...
//        $sql="SELECT a.order_user,d.disp_name,a.status,a.order_code,a.city,a.lcd,b.order_id,b.goods_id,b.goods_num,b.confirm_num,c.goods_code,c.name AS goods_name,c.costing AS goods_cost,e.name AS classify_name
        $sql="SELECT a.order_user,d.disp_name,a.status,a.order_code,a.city,a.lcd,b.order_id,b.goods_id,b.goods_num,b.confirm_num,c.goods_code,c.name AS goods_name,c.costing AS goods_cost,e.name AS classify_name,c.price AS goods_price 
FROM opr_order a 
