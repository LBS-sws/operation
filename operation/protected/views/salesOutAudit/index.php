<?php
$this->pageTitle=Yii::app()->name . ' - salesOutAudit List';
?>
<?php
//2024年9月28日09:28:46
?>
...
<section class="content">
        ...
        <div class="box-body">
            ...
            <div class="btn-group" role="group">
                ...
                echo TbHtml::button('<span class="fa fa-paper-plane"></span> '.Yii::t('procurement','All shipments'), array(
                    'submit'=>Yii::app()->createUrl('salesOutAudit/allApproved'),
                ));
                ?>
            </div>
            -->
    ...
    $this->widget('ext.layout.ListPageWidget', array(
        'title'=>Yii::t('app','Sales outbound audit'),
        'model'=>$model,
        'viewhdr'=>'//salesOutAudit/_listhdr',
        'viewdtl'=>'//salesOutAudit/_listdtl',
...
<form class="form-horizontal" action="<?php echo Yii::app()->createUrl('salesOutAudit/allDownload');?>" method="get">
    <?php
    $ftrbtn = array();
    $ftrbtn[] = TbHtml::button(Yii::t('dialog','Close'), array('data-dismiss'=>'modal','color'=>TbHtml::BUTTON_COLOR_DEFAULT,"class"=>"pull-left"));
    $ftrbtn[] = TbHtml::button(Yii::t('procurement','Submit'), array('data-dismiss'=>'modal','color'=>TbHtml::BUTTON_COLOR_PRIMARY,'submit' => Yii::app()->createUrl('salesOutAudit/allDownload')));
