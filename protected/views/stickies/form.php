...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('procurement','Stickies Form'); ?></strong>
	</h1>
<!--
	<ol class="breadcrumb">
...
<section class="content">
	...
	<div class="btn-group" role="group">
		<?php echo TbHtml::button('<span class="fa fa-reply"></span> '.Yii::t('misc','Back'), array(
				'submit'=>Yii::app()->createUrl('stickies/index')));
		?>
<?php if ($model->scenario!='view'): ?>
			<?php echo TbHtml::button('<span class="fa fa-upload"></span> '.Yii::t('misc','Save'), array(
				'submit'=>Yii::app()->createUrl('stickies/save')));
			?>
<?php endif ?>
        <?php if ($model->scenario=='edit'): ?>
            <?php echo TbHtml::button('<span class="fa fa-remove"></span> '.Yii::t('misc','Delete'), array(
                'submit'=>Yii::app()->createUrl('stickies/delete')));
            ?>
        <?php endif ?>
	</div>
	</div></div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <?php echo $form->textArea($model, 'content',
                        array('row'=>4,'readonly'=>($model->scenario=='view'))
                    ); ?>
                </div>
            </div>
		</div>
