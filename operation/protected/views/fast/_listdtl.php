<?php
$htmlTrHref = $this->getLink('YC01', 'fast/edit', 'fast/view', array('index'=>$this->record['id']));
...
?>
	<td><?php echo $this->drawEditButton('YC01', 'fast/edit', 'fast/view', array('index'=>$this->record['id'])); ?></td>
