...
<?php endif ?>
	...
	<th>
		<?php echo TbHtml::link(Yii::t("monthly",'清洁收入').$this->drawOrderArrow('val_1'),'#',$this->createOrderLink('monthly-list','val_1'))
			;
		?>
	</th>
	<th>
		<?php echo TbHtml::link(Yii::t("monthly",'灭虫收入').$this->drawOrderArrow('val_2'),'#',$this->createOrderLink('monthly-list','val_2'))
			;
		?>
	</th>
	<th>
		<?php echo TbHtml::link(Yii::t("monthly",'纸品收入').$this->drawOrderArrow('val_6'),'#',$this->createOrderLink('monthly-list','val_6'))
			;
		?>
	</th>
	<th>
		<?php echo TbHtml::link(Yii::t("monthly",'杂项及其他销售收入').$this->drawOrderArrow('val_3'),'#',$this->createOrderLink('monthly-list','val_3'))
			;
		?>
	</th>
	<th>
		<?php echo TbHtml::link(Yii::t("monthly",'飘盈香收入').$this->drawOrderArrow('val_4'),'#',$this->createOrderLink('monthly-list','val_4'))
			;
		?>
	</th>
	<th>
		<?php echo TbHtml::link(Yii::t("monthly",'甲醛收入').$this->drawOrderArrow('val_5'),'#',$this->createOrderLink('monthly-list','val_5'))
			;
		?>
	</th>
	<th>
