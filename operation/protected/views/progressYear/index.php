<?php
$this->pageTitle=Yii::app()->name . ' - ProgressYear';
?>

<?php $form=$this->beginWidget('TbActiveForm', array(
'id'=>'progressYear-list',
...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('app','Progress Year leaderboard'); ?></strong>
	</h1>
<!--
	<ol class="breadcrumb">
...
<section class="content">
    ...
    $this->widget('ext.layout.ListPageWidget', array(
        'title'=>Yii::t('app','Progress Year leaderboard'),
        'model'=>$model,
        'viewhdr'=>'//progressYear/_listhdr',
        'viewdtl'=>'//progressYear/_listdtl',
        'gridsize'=>'24',
        'height'=>'600',
