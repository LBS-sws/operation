...
?>
<?php
$htmlTrHref = $this->getLink('YC03', 'salesOut/edit', 'salesOut/view', array('index'=>$this->record['id']));
...
?>
	<td><?php echo $this->drawEditButton('YC03', 'salesOut/edit', 'salesOut/view', array('index'=>$this->record['id'])); ?></td>
