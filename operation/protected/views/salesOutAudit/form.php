...
<section class="content-header">
    <h1>
        <strong><?php echo Yii::t('app','Sales outbound audit'); ?></strong>
    </h1>
    <!--
        <ol class="breadcrumb">
    ...
    <div class="box"><div class="box-body">
            <div class="btn-group" role="group">
                <?php echo TbHtml::button('<span class="fa fa-reply"></span> '.Yii::t('misc','Back'), array(
                    'submit'=>Yii::app()->createUrl('salesOutAudit/index')));
                ?>
...
/*                        echo TbHtml::button('<span class="fa fa-mail-reply-all"></span> ' . Yii::t('procurement', 'Reject'), array(
                            'submit' => Yii::app()->createUrl('salesOutAudit/reject')));*/
                        echo TbHtml::button('<span class="fa fa-mail-reply-all"></span> '.Yii::t('procurement','Reject'), array(
                    ...
                    echo TbHtml::button('<span class="fa fa-cloud-download"></span> '.Yii::t('procurement','Down'), array(
                        'submit'=>Yii::app()->createUrl('salesOutAudit/downorder',array("index"=>$model->id))));
                } ?>
            </div>
        </div></div>
...
<?php
$this->renderPartial('//site/ject',array('model'=>$model,'form'=>$form,'submit'=>Yii::app()->createUrl('salesOutAudit/reject')));
?>
<?php
$js = "
...
<?php if ($model->status == "finished"): ?>
    <form id="black_form" role="dialog" tabindex="-1" method="post" class="modal fade form-horizontal" action="<?php echo Yii::app()->createUrl('salesOutAudit/black');?>">
