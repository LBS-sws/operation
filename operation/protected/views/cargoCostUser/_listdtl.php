<?php
$htmlTrHref = $this->getLink('YD02', 'cargoCostUser/view', 'cargoCostUser/view', array('index'=>$this->record['id']));
...
?>
	<td><?php echo $this->drawEditButton('YDDD', 'cargoCostUser/view', 'cargoCostUser/view', array('index'=>$this->record['id'])); ?></td>
