<?php
$htmlTrHref = $this->getLink('YS04', 'fast/edit', 'fast/view', array('index'=>$this->record['id']));
...
?>
	<td><?php echo $this->drawEditButton('YS04', 'fast/edit', 'fast/view', array('index'=>$this->record['id'])); ?></td>
