<?php
$this->pageTitle=Yii::app()->name . ' - ProgressMonth';
?>

<?php $form=$this->beginWidget('TbActiveForm', array(
'id'=>'progressMonth-list',
...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('app','Progress Month leaderboard'); ?></strong>
	</h1>
<!--
	<ol class="breadcrumb">
...
<section class="content">
    ...
    if(Yii::app()->user->validFunction('YN10')) {
        $search_add_html .= TbHtml::dropDownList("{$modelClass}[allCity]", $model->allCity, ProgressMonthList::getAllCityTypeList(),
    ...
    $this->widget('ext.layout.ListPageWidget', array(
        'title'=>Yii::t('app','Progress Month leaderboard'),
        'model'=>$model,
        'viewhdr'=>'//progressMonth/_listhdr',
        'viewdtl'=>'//progressMonth/_listdtl',
        'gridsize'=>'24',
        'height'=>'600',
